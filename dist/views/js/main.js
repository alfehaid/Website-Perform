...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var contain=document.getElementsByClassName("randomPizzaContainer");
    for (var i = 0; i < contain.length; i++) {
      contain[i].style.width = newwidth + "%";
    }
  }
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var rows = Math.floor(window.screen.height / s);//calculates no of rows
